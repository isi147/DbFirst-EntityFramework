...
public partial class LibraryContext : DbContext
{
    ...
    public virtual DbSet<KvasTukani> KvasTukanis { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=STHQ0116-01;Initial Catalog=Library;User ID=admin;Password=admin;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Cafe__3214EC072A0D476B");

            entity.ToTable("Cafe");

            entity.Property(e => e.Id).ValueGeneratedNever();
            entity.Property(e => e.Menu).HasMaxLength(202);
            entity.Property(e => e.Name).HasMaxLength(103);
        });
        ...
        modelBuilder.Entity<KvasTukani>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__KvasTuka__3214EC074E439427");

            entity.ToTable("KvasTukani");
